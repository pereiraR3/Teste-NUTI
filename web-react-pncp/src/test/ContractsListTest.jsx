...
const ContractsListTest = ({ orgao, contracts, totalValue }) => {
              ...
              <tbody>
                {currentContracts.map((contract, index) => (
                  <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td className="px-2 sm:px-6 py-4">{contract.valorInicial.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</td>
                  </tr>
                ))}
              </tbody>
            </table>
...
export default ContractsListTest;
